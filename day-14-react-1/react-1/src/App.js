...
function App() {
  ...
  let onClickImage = () => {
    alert("tes click image");
  };
  let condition = false;
  // if (condition) {
  //   console.log("true benar sekali");
  // } else {
  //   console.log("salah");
  // }
  const number = [1, 2, 3, 4, 1];
  const listNumber = number.map((item, id) => {
    return (
      <ul key={id}>
        <li>{item}</li>
      </ul>
